...
<Sprite key="buttonAuto" anchor={0.5} x={uiX(0.668)} y={uiY(0.462)} width={smallButtonSize} height={smallButtonSize} blendMode={BLEND_MODE} zIndex={22} />
<Sprite key="buttonBuy" anchor={0.5} x={uiX(0.776)} y={uiY(0.462)} width={smallButtonSize} height={smallButtonSize} blendMode={BLEND_MODE} zIndex={22} />
