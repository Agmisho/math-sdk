...
export const SPIN_OPTIONS_DEFAULT = { ...SPIN_OPTIONS_SHARED, reelPreSpinSpeed: 2, reelSpinSpeed: 3, reelBounceSizeMulti: 0.3 };
export const SPIN_OPTIONS_FAST = { ...SPIN_OPTIONS_SHARED, reelPreSpinSpeed: 3.7, reelSpinSpeed: 4, reelBounceSizeMulti: 0.08 };
